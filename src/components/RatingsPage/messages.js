export default {
  ...
  topParticipants: {
    ...
    defaultMessage: 'Топ-{topLimit} участников',
    description: 'Текст под названием валюты/организации, показывающий лимит топа',
  },
  topEmpty: {
  ...
  participatesButNotInTop: {
    ...
    defaultMessage: 'Вы участвуете в рейтинге, но пока не вошли в топ-{topLimit}',
    description: 'Основной текст сообщения, когда пользователь участвует, но не попал в топ',
  },
  needMoreExperience: {
    id: 'profile.ratings.needMoreExperience',
    defaultMessage: 'Чтобы попасть в рейтинг, нужно набрать больше опыта. Продолжайте проходить курсы!',
    description: 'Мотивирующий текст под основным сообщением',
  },
  notParticipates: {
    id: 'profile.ratings.notParticipates',
    defaultMessage: 'Вы не участвуете в этом рейтинге.',
    description: 'Сообщение, когда участие в рейтинге выключено',
  },
  enableInHistory: {
